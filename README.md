...
This repo contains my personal dotfiles and are heavily based on [paul](https://github.com/paulirish/dotfiles/), [mathias](https://github.com/mathiasbynens/dotfiles/)'s and [addyosmani](https://github.com/addyosmani/dotfiles)'s.
...
```bash
git clone https://github.com/jlnslv/dotfiles.git && cd dotfiles && ./sync.sh
```
